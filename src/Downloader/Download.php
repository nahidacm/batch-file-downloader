...
class Download extends Command{
    ...
    protected function configure(){
        $this->setName("downloader:download")
            ->setDescription("Downloads files/Images from csv to local. arguments: full input file path")
        ...
        try{
            ...
            while (($row_data = fgetcsv($handle, 99999999, ",")) !== FALSE) {
                ...
                foreach ($images as $image_link){
                    ...
                    $output->writeln('Row: '.$row.' -Downloading: '.$image_link);
                    ...
                    $file = fopen($file_name , 'w') or die("Failed to create file on your PC. Most probably permission issue.");
